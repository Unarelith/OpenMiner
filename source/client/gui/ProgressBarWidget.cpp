...
void ProgressBarWidget::init(const FloatRect &clipRect, const Vector2i &position, const std::string &meta, unsigned int maxMetaValue) {
	m_clipRect = clipRect;
	m_position = position;
...
void ProgressBarWidget::init(const FloatRect &clipRect, const Vector2i &position, const std::string &meta, const std::string &maxMeta) {
	m_clipRect = clipRect;
	m_position = position;
