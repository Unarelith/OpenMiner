...
class TerrainGenerator {
	...
	private:
		...
		void generateUndergroundBiomes(ServerChunk &chunk, int x, int y, int z, const Biome &biome, Random_t &rand) const;

		void randomWalkReplace(ServerChunk &chunk, int x, int y, int z, Random_t &rand, u16 oreBlock, u16 deepBlock, int size) const;
		void oreFloodFill(ServerChunk &chunk, double x, double y, double z, Random_t &rand, u16 toReplace, u16 replaceWith, int depth) const;
